...
import { updateProductStart } from '../../../redux/actions/product.action';
...
const EditProduct = () => {
    ...
    const [formData, uploadStatus, setFormData, inputChange, uploadFiles] = useFormData(initialState, 'product')

    const searchProductById = useCallback((id) => {
      if (!id) {
        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className='relative'>
                    <h3 className='py-3 mb-4 w-full font-mono text-2xl md:text-5xl text-center font-bold text-red-600 bg-orange-300'>Update Product</h3>
