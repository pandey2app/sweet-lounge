...
const Footer = () => {
    return (
        <>
            <footer className="text-white bg-slate-400 body-font">
                ...
                <div className="bg-slate-800">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-white text-sm text-center sm:text-left">© 2020 Aditya prakash pandey —
                            <Link to="https://twitter.com/pandey2app" rel="noopener noreferrer" className="text-white ml-1" target="_blank">@pandey2app</Link>
                        </p>
